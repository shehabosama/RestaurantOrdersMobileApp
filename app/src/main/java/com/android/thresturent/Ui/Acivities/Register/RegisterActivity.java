package com.android.thresturent.Ui.Acivities.Register;
...
public class RegisterActivity extends BaseActivity implements RegisterContract.View {
    ...
    public void loginSuccess() {
        Message.message(RegisterActivity.this,"login successfully");
        hideProgress();
        LoginActivity.startActivity(RegisterActivity.this,"user");
        finish();
    }
