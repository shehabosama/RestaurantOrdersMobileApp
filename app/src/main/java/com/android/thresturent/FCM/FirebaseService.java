...
public class FirebaseService extends FirebaseMessagingService
{
    ...
    private void generateNotification(String title, String message) {
        ...
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(this)
                .setSmallIcon(R.drawable.restaurant_logo)  //a resource for your custom small icon
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            NotificationChannel notificationChannel = new NotificationChannel("123", "Restaurant_channel", importance);
